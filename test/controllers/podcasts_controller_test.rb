...
class PodcastsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create podcast" do
    assert_difference('Podcast.count') do
      post podcasts_url, params: { podcast: { desctiption: @podcast.desctiption, feed: @podcast.feed, homepage: @podcast.homepage, host: @podcast.host, name: @podcast.name } }
    end
  ...
  test "should update podcast" do
    patch podcast_url(@podcast), params: { podcast: { desctiption: @podcast.desctiption, feed: @podcast.feed, homepage: @podcast.homepage, host: @podcast.host, name: @podcast.name } }
