...
class PodcastsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create podcast" do
    assert_difference('Podcast.count') do
      post podcasts_url, params: { podcast: { description: @podcast.description, feed: @podcast.feed, homepage: @podcast.homepage, host: @podcast.host, name: @podcast.name } }
    end
  ...
  test "should update podcast" do
    patch podcast_url(@podcast), params: { podcast: { description: @podcast.description, feed: @podcast.feed, homepage: @podcast.homepage, host: @podcast.host, name: @podcast.name } }
